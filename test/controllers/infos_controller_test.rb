...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { address: @info.address, age: @info.age, birthdate: @info.birthdate, email: @info.email, name: @info.name, picture: @info.picture, state: @info.state, zip: @info.zip } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { address: @info.address, age: @info.age, birthdate: @info.birthdate, email: @info.email, name: @info.name, picture: @info.picture, state: @info.state, zip: @info.zip } }
